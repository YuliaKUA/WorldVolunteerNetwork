...
{
    public record CreatePostWithPhotoRequest(
        Guid OrganizerId,
        ...
        //List<PostPhotoRequest> photos
        IFormFileCollection Files
    );

    public class CreatePostWithPhotoRequestValidator : AbstractValidator<CreatePostWithPhotoRequest>
    {
        public CreatePostWithPhotoRequestValidator()
        {
